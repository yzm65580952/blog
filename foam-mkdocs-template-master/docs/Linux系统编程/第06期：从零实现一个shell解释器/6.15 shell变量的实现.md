...
int is_env_command (char *arglist[])//检测是否是环境变量命令
{
...
int env_cmd_store (char *arglist[])	//解析出环境变量，保存到数组里
{
    char *temp = arglist[0];
    int i = 0;
    if (val_num >= MAX_VAL)
...
* Last Modified: 2019-08-22 12:26:06
************************************************/
#include <stdio.h>
#include <unistd.h>
#include <stdlib.h>
